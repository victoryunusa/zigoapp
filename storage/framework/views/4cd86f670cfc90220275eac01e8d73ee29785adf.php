...
<div class="sidenav custom-sidenav" id="sidenav-main">
    ...
    <div class="sidenav-header d-flex align-items-center">
        <a class="navbar-brand" href="<?php echo e(route('dashboard')); ?>">
            <img src="<?php echo e($logo.'/'.(isset($company_logo) && !empty($company_logo)?$company_logo:'white.svg')); ?>" class="navbar-brand-img"/>
        </a>
        <div class="ml-auto">
...
<?php /**PATH /Applications/MAMP/htdocs/zigoair/resources/views/partials/admin/menu.blade.php ENDPATH**/ ?>