...
<html lang="en">
   <head>
      ...
      <link href="<?php echo e(asset('main/vendor/icofont/icofont.min.css')); ?>" rel="stylesheet">
      <link href="<?php echo e(asset('main/vendor/slick/slick.min.css')); ?>" rel="stylesheet">
      <link href="<?php echo e(asset('main/vendor/slick/slick-theme.min.css')); ?>" rel="stylesheet">
      <link href="<?php echo e(asset('main/css/style.css')); ?>" rel="stylesheet">
      <link href="<?php echo e(asset('main/vendor/font/stylesheet.css')); ?>" rel="stylesheet">
      <link href="<?php echo e(asset('main/vendor/animation/animate.min.css')); ?>" rel="stylesheet">
   </head>
   <body>
               ...
               <div class="collapse navbar-collapse" id="navbarResponsive">
                  ...
                  <ul class="navbar-nav ml-auto login-btn">
                     ...
                     <li class="nav-item active ml-1">
                        <a class="nav-link" href="<?php echo e(url('register')); ?>">Get Started</a>
                     </li>
                  </ul>
               </div>
            </div>
            ...
            <div class="container h-100">
               <div class="row h-100">
                  <div class="col-md-8 mx-auto text-center header-title">
                     ...
                     <img src="<?php echo e(asset('main/img/screen.jpeg')); ?>" class="img-fluid header-img slideanim">
                  </div>
               </div>
            </div>
         </header>
      ...
      <script type="4d954a710c497242433396a4-text/javascript" src="<?php echo e(asset('main/vendor/jquery/jquery.min.js')); ?>"></script>
      <script type="4d954a710c497242433396a4-text/javascript" src="<?php echo e(asset('main/vendor/bootstrap/js/bootstrap.bundle.min.js')); ?>"></script>
      <script type="4d954a710c497242433396a4-text/javascript" src="<?php echo e(asset('main/vendor/slick/slick.min.js')); ?>"></script>
      <script type="4d954a710c497242433396a4-text/javascript" src="<?php echo e(asset('main/vendor/animations/float-panel.js')); ?>"></script>
      <script type="4d954a710c497242433396a4-text/javascript" src="<?php echo e(asset('main/js/osahan.js')); ?>"></script>
 ...
 </html><?php /**PATH /Applications/MAMP/htdocs/zigoair/resources/views/layouts/main.blade.php ENDPATH**/ ?>